...
let PermissionsController = class PermissionsController {
    ...
    grant(req, body) {
        return this.permissionsService.grantPermission(req.user.id, body.targetUserId, body.permissionAtom);
    }
    revoke(req, body) {
        return this.permissionsService.revokePermission(req.user.id, body.targetUserId, body.permissionAtom);
    }
};
